    ...
    return (
        <footer className="footer grid-rows-2 p-10 mt-12 bg-gray-900 text-[#eee]">
            ...
            <aside className='flex flex-col items-center gap-2 w-full'>
                <div>
                    <header className="footer-title text-[var(--main-color)] opacity-80">Social Media and Copyright</header>
            ...
            <nav>
                <header className="footer-title text-[var(--main-color)] opacity-80">Services</header>
            ...
            <nav>
                <header className="footer-title text-[var(--main-color)] opacity-80">Classes</header>
            ...
            <nav>
                <header className="footer-title text-[var(--main-color)] opacity-80">Explore</header>
            ...
            <nav>
                <header className="footer-title text-[var(--main-color)] opacity-80">Legal</header>
