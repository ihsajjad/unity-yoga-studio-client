  ...
  return (
    <div className="md:px-20 py-10 px-3 min-h-screen mx-auto bg-[var(--primary-bg)] border flex md:flex-row flex-col justify-between items-center gap-10 ">
      <div className="flex-1 h-full">
        <Lottie animationData={loginAnimation} className="w-full h-[90vh]" />
      </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="card-body">
          <div className="form-control">
            ...
            <input
              ...
              onChange={(e) => setValue("resetEmail", e.target.value)} // Set resetEmail state here
            />
          </div>
          <div className="form-control">
            <label className="label">
          ...
          <div className="form-control mt-2">
            <input
              className="custom-btn-secondary uppercase"
              type="submit"
              value="Login"
            />
          </div>
