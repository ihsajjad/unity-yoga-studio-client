const NewsSection = () => {
  return (
    ...
    <section className="section-container w-auto h-full text-center bg-opacity-50  ">
      {/* <div className="">
     <h1 className="section-title">Subscribe To Our Newsletter</h1>
      ...
      <div className="flex flex-col md:flex-row ">
        <div className="md:flex-1">
          <img
            src="https://zakratheme.com/blog/wp-content/uploads/2023/06/Zakra-Blog-Newsletter-scaled.webp"
            alt="Image"
