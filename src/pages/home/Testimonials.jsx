        ...
        <div className="w-fit">
          {testimonials.map((testimonail) => (
            <SwiperSlide key={testimonail._id} className="md:pb-12 pb-8 w-full">
              <div className="h-[450px] w-full mx-auto space-y-3 flex flex-col items-center border border-[var(--secondary-color)] p-8 bg-[var(--primary-bg)] rounded-lg shadow-lg shadow-[#5d5db85c] mt-auto">
                <img
                ...
                <div className="w-full flex gap-2 mb-auto">
                  <FaQuoteLeft className="w-24 text-2xl text-[var(--main-color)]" />
                  <p className="text-justify"> {testimonail.quote}</p>
                </div>
                <span className="mt-auto h-fit text-[var(--secondary-color)] font-bold ">
                  {testimonail.date}
                </span>
              </div>
            </SwiperSlide>
